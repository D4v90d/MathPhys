...
There are 4 fields that can be filled by user
1. Length of X-axis: set length of the horizontal line of the graph that will be drawn.
2. Length of Y-axis: set length of the vertical line of the graph that will be drawn.
3. Start point from X: set the starting X-axis coordinate.
4. Incremental factor: adjust speed of the graph will be drawn.

What if I use a smaller/bigger increment factor?
    - Smaller = Graphing process is slower
    - Bigger = Graphing process is faster
