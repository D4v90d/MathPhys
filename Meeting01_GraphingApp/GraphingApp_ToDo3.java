/*
Todo 3
What happens if use the function 1/x for the graph?

Answer= Graph will keep plotting as intended while avoiding reaching the coordinate 0. Since we use 1/x as the graphing function, division by 0 is not allowed thus
        the program will do its best to steer away from point 0 while graphing near it.
*/
