...
class Shooter {
    ...
    public Shooter() {
        ...
        JLabel BltVelocity = new JLabel("Bullet velocity");
        JTextField velocity = new JTextField(20);
        BltVelocity.setLabelFor(velocity);
        //velocity.setBounds(5, 5, cpSize - 5, frame.getHeight());
        velocity.setBounds(5, 5, cpSize - 5, 30);
        frame.add(velocity);
    ...
    class Bullet {
        ...
        public Bullet(double radius, int originX, int originY, double angle, double timeInitial, int baseVelocity){
